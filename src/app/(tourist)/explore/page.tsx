      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 py-8 space-y-8">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-6 sm:p-10 relative overflow-hidden">
          <div className="max-w-2xl space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <Link href="/">
                <Button className="bg-black text-white hover:bg-neutral-800 text-xs h-10 px-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedIsland.features.map((f) => (
                    <Badge
                      key={f}
                      variant="subtle"
                      className="border-neutral-200 bg-neutral-50 text-neutral-800 text-xs py-1"
                    >
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="rounded-xl border border-neutral-200 p-5 space-y-2 bg-neutral-50/50">
            <Ship className="h-5 w-5 text-neutral-900" />
        ...
        <section className="space-y-4 pt-4">
          <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h2 className="text-base font-bold text-neutral-900">Find Your Stay Near Bretania Port</h2>
              <p className="text-xs text-neutral-600 mt-1">Browse all accredited homestays and resorts available for booking.</p>
            </div>
            <Link
              href="/"
              className="shrink-0 inline-flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-black text-white text-xs font-semibold hover:bg-neutral-800 transition-colors"
            >
              Browse All Stays
